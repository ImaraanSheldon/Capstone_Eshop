<template>
    <div class="card">
        <svg class="card-image" xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
            viewBox="0 0 16 16">
        ...
        <svg text-rendering="geometricPrecision" shape-rendering="geometricPrecision" height="50" width="50"
            viewBox="0 0 200 350" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
            class="ring-1">
            <defs>
                <radialGradient gradientTransform="matrix(1 0 0 0.860612 0.5 0.618787)"
                    gradientUnits="objectBoundingBox" spreadMethod="pad" r="0.5" cy="0" cx="0" id="ebT4AgJ0WZ62-fill">
                ...
                <radialGradient gradientTransform="matrix(0.999964 0.008506 -0.012489 1.468176 0.496001 0)"
                    gradientUnits="objectBoundingBox" spreadMethod="pad" r="0.803687" cy="0" cx="0"
            ...
            <path fill="url(#ebT4AgJ0WZ62-fill)" transform="translate(.79738 0.07381)"
            ...
            <path fill="url(#ebT4AgJ0WZ63-fill)" transform="matrix(1 0 0-1-20.148641 311.37469)"
        ...
        <svg text-rendering="geometricPrecision" shape-rendering="geometricPrecision" height="45" width="45"
            viewBox="0 0 200 350" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
            class="ring-2">
            <defs>
                <radialGradient gradientTransform="matrix(1 0 0 0.860612 0.5 0.618787)"
        ...
        <svg text-rendering="geometricPrecision" shape-rendering="geometricPrecision" height="50" width="50"
            viewBox="0 0 200 300" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
            class="ring-3">
            <defs>
                <radialGradient gradientTransform="matrix(1 0 0 0.860612 0.5 0.618787)"
                    gradientUnits="objectBoundingBox" spreadMethod="pad" r="0.5" cy="0" cx="0" id="ebT4AgJ0WZ62-fill">
